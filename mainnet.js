...
module.exports = {
  ...
  detectLastClaimTime: function () {
    ...
    this.eos.getTableRows({
      ...
      if (Date.now() - last_claim_time >= 24 * 60 * 60 * 1000) {
        ...
        console.log('can not claim reward on EOS mainnet right now.');
      }
    });
  ...
  claimReward: function () {
    ...
    this.eos.transaction({
      ...
      console.log('claim reward failed on EOS mainnet.');
      console.log(err);
    });
  },
  ...
  sendMessage: function (date, balance) {
    var params = {
      "msgtype": "text",
      "text": {
        "content": date + ",claimed reward on EOS mainnet, " + this.producerName + " : " + balance
      }
    };
    var options = {
      method: 'POST',
