const eosutils = require('./eos-utils.js')
{
  const eosClaimer = new eosutils.Claimer(
...
{
  const bosClaimer = new eosutils.Claimer(
...
{
  const meetoneClaimer = new eosutils.Claimer(
